-- =============================================
-- E-COMMERCE MINI SHOP DATABASE SCHEMA
...
('iPhone 15 Pro Max', 'iphone-15-pro-max', 'iPhone 15 Pro Max với chip A17 Pro mạnh mẽ, camera 48MP và màn hình Super Retina XDR 6.7 inch.', 'iPhone 15 Pro Max - Flagship mới nhất từ Apple', 29990000, 27990000, 'IPH15PM-256', 50, 1, 'Apple', TRUE, 'active'),
('Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'Galaxy S24 Ultra với S Pen, camera 200MP và màn hình Dynamic AMOLED 2X 6.8 inch.', 'Galaxy S24 Ultra - Điện thoại Android cao cấp', 26990000, 24990000, 'SGS24U-512', 30, 1, 'Samsung', TRUE, 'active'),
('MacBook Pro M3', 'macbook-pro-m3', 'MacBook Pro 14 inch với chip M3, 16GB RAM và SSD 512GB.', 'MacBook Pro M3 - Laptop chuyên nghiệp', 45990000, 42990000, 'MBP14-M3-512', 20, 2, 'Apple', TRUE, 'active'),
('Dell XPS 13', 'dell-xps-13', 'Dell XPS 13 với Intel Core i7, 16GB RAM và SSD 512GB.', 'Dell XPS 13 - Laptop cao cấp', 28990000, 26990000, 'DXPS13-I7-512', 25, 2, 'Dell', FALSE, 'active'),
('Apple Watch Series 9', 'apple-watch-series-9', 'Apple Watch Series 9 với chip S9, màn hình Always-On và nhiều tính năng sức khỏe.', 'Apple Watch Series 9 - Đồng hồ thông minh', 8990000, 7990000, 'AWS9-45MM', 40, 3, 'Apple', TRUE, 'active'),
('Samsung Galaxy Watch 6', 'samsung-galaxy-watch-6', 'Galaxy Watch 6 với Wear OS, theo dõi sức khỏe và pin 2 ngày.', 'Galaxy Watch 6 - Đồng hồ thông minh Android', 5990000, 5490000, 'SGW6-44MM', 35, 3, 'Samsung', FALSE, 'active'),
('AirPods Pro 2', 'airpods-pro-2', 'AirPods Pro thế hệ 2 với chip H2, chống ồn chủ động và âm thanh không gian.', 'AirPods Pro 2 - Tai nghe không dây cao cấp', 5990000, 5490000, 'APP2-USB-C', 60, 4, 'Apple', TRUE, 'active'),
('Sony WH-1000XM5', 'sony-wh-1000xm5', 'Sony WH-1000XM5 với chống ồn hàng đầu và âm thanh chất lượng cao.', 'Sony WH-1000XM5 - Tai nghe chống ồn', 8990000, 7990000, 'SW1000XM5', 15, 4, 'Sony', FALSE, 'active'),
('Gaming Chair Pro', 'gaming-chair-pro', 'Ghế gaming cao cấp với đệm lưng và cổ, điều chỉnh chiều cao và màu RGB.', 'Gaming Chair Pro - Ghế gaming chuyên nghiệp', 2999000, 2499000, 'GC-PRO-RGB', 20, 5, 'Gaming Pro', FALSE, 'active'),
('Mechanical Keyboard RGB', 'mechanical-keyboard-rgb', 'Bàn phím cơ RGB với switch Cherry MX Blue và đèn LED đa màu.', 'Mechanical Keyboard RGB - Bàn phím gaming', 1999000, 1799000, 'MKB-RGB-MX', 30, 5, 'Gaming Gear', FALSE, 'active'),
('Gaming Mouse Wireless', 'gaming-mouse-wireless', 'Chuột gaming không dây với DPI cao, RGB và pin 70 giờ.', 'Gaming Mouse Wireless - Chuột gaming cao cấp', 1299000, 999000, 'GM-WIRELESS-RGB', 25, 5, 'Gaming Gear', FALSE, 'active'),
('Monitor 4K 27 inch', 'monitor-4k-27-inch', 'Màn hình 4K 27 inch với tần số quét 144Hz và HDR.', 'Monitor 4K 27 inch - Màn hình gaming', 8999000, 7999000, 'MON-4K-27-144', 10, 5, 'Gaming Display', TRUE, 'active');
...
('ORD001', 2, 'Nguyễn Văn A', 'customer1@email.com', '0987-654-321', '123 Đường ABC, Quận 1, TP.HCM', 27990000, 30000, 28020000, 'cod', 'pending', 'pending'),
('ORD002', 3, 'Trần Thị B', 'customer2@email.com', '0912-345-678', '456 Đường XYZ, Quận 2, TP.HCM', 42990000, 0, 42990000, 'bank_transfer', 'paid', 'confirmed');
...
(1, 2, 'Nguyễn Văn A', 'customer1@email.com', 5, 'Sản phẩm tuyệt vời!', 'iPhone 15 Pro Max rất đẹp và mượt mà. Camera chụp ảnh rất đẹp!', 'approved'),
(3, 3, 'Trần Thị B', 'customer2@email.com', 5, 'MacBook Pro M3 xuất sắc', 'MacBook Pro M3 xử lý rất nhanh, pin trâu. Rất hài lòng với sản phẩm!', 'approved'),
(1, NULL, 'Khách hàng', 'guest@email.com', 4, 'Tốt nhưng giá hơi cao', 'Sản phẩm chất lượng tốt nhưng giá hơi cao so với túi tiền.', 'approved');
